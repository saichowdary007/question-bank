...
def _build_prompt(page_text: str) -> str:
    ...
    return f"""You are an intelligent educational assistant.\n\nRead the following page excerpt from a school book (Grades 1–10) and identify its main concepts.\nGenerate between 3 and 5 multiple-choice questions (MCQs) that test understanding of those concepts.\n\nRules:\n1. If the text is empty, irrelevant, or lacks educational meaning, return an empty array: []\n2. Provide 3 to 5 questions total only if content is meaningful.\n3. Each question must stem directly from the provided text.\n4. Do not repeat or rephrase existing questions within the same list.\n5. Do not generate generic or placeholder questions like \"What is the page number of this text?\"\n6. Give exactly 4 answer options labelled A–D in an array.\n7. Clearly indicate the correct answer for each question using the same letter (e.g., \"A\").\n8. Return ONLY a valid JSON array of objects in the form:\n\n[\n  {{\"question\": \"...\", \"options\": [\"A\", \"B\", \"C\", \"D\"], \"answer\": \"A\"}},\n  ...\n]\n\nText:\n\"\n{page_text}\n\"\n"""