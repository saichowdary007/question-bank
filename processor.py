...
def _build_prompt(page_text: str) -> str:
    ...
    return f"""You are an intelligent educational assistant.\n\nRead the following page excerpt from a school book (Grades 1–10) and identify its main educational concepts.\n\nCONTENT VALIDATION:\n- If the text is empty, contains only page numbers, headers, footers, navigation elements, or lacks substantive educational content (less than 30 meaningful words), return: []\n- If the text is fragmented, corrupted, or incomprehensible, return: []\n- Text must contain at least one clear educational concept with explanation\n\nCONCEPT VERIFICATION:\nBefore generating questions, check if the text contains:\n- Definitions, explanations, or descriptions of concepts\n- Processes, functions, or cause-and-effect relationships\n- Scientific facts or information with context\n- If no clear concepts are explained, return: []\n\nQUESTION GENERATION RULES:\nOnly if content contains clear educational concepts:\n1. Generate as many meaningful multiple-choice questions as possible, aiming for at least 9 questions when content allows, maximum 15 questions\n2. Create questions from different aspects of each concept: definitions, applications, examples, processes, causes, effects, characteristics, functions\n3. Each question MUST be based on specific information explained in the text\n4. STRICTLY AVOID these question types and phrases:\n   - "What is mentioned in this text?"\n   - "What does this text discuss?"\n   - "According to the text..."\n   - "In this passage..."\n   - "In this text..."\n   - "In the text..."\n   - "In this..."\n   - "The text states..."\n   - "As described in the content..."\n   - "According to the figure shown..."\n   - "In the diagram..."\n   - "In this figure..."\n   - "In the fig..."\n   - "In this fig..."\n   - "The passage explains..."\n   - "Based on the reading..."\n   - "From the passage..."\n   - "The content shows..."\n   - "As shown above..."\n   - "As mentioned..."\n   - "This section discusses..."\n   - Any reference to "text", "passage", "content", "figure", "diagram", "reading", "section", "above", "below"\n   - Generic questions about page content or what is discussed\n5. Questions must be STANDALONE and self-contained without any reference to source material\n6. Frame questions as direct knowledge tests (e.g., "What causes...?", "How does...?", "Which process...?", "What is the definition of...?", "What happens when...?")\n7. Each question must have exactly 4 options labeled A-D with only one clearly correct answer\n8. Focus on testing understanding of key concepts, processes, or facts explained in the text\n9. If you cannot create at least 3 meaningful standalone questions from the content, return: []\n\nOUTPUT FORMAT:\nReturn ONLY valid JSON array format:\n\n[\n  {{"question": "...", "options": ["A", "B", "C", "D"], "answer": "A"}},\n  ...\n]\n\nText:\n"\n{page_text}\n"\n"""